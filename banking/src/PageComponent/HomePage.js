...
import travel_1 from "../Images/banking_image3.jpeg";
import travel_2 from "../Images/banking_image1.jpeg";
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-8 text-color">
            ...
            <Link to="/user/login" className="btn bg-info custom-bg-text">
              Get Started
            </Link>
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-8 text-color">
            ...
            <Link to="/user/login" className="btn bg-info custom-bg-text ms-5">
              Get Started
            </Link>
          </div>
        </div>
