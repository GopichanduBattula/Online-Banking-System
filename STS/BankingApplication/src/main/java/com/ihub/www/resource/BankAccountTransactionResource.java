...
import com.ihub.www.exception.BankAccountTransactionException;
import com.ihub.www.service.BankAccountService;
import com.ihub.www.service.BankAccountTransactionService;
import com.ihub.www.service.BankService;
import com.ihub.www.service.UserService;
import com.ihub.www.utility.BankStatementDownloader;
import com.ihub.www.utility.Constants.BankAccountStatus;
import com.ihub.www.utility.Constants.TransactionNarration;
import com.ihub.www.utility.Constants.TransactionType;
import com.ihub.www.utility.Constants.UserStatus;
import com.ihub.www.utility.DateTimeUtils;
import com.ihub.www.utility.TransactionIdgenerator;
...
public class BankAccountTransactionResource {
	...
	public ResponseEntity<CommonApiResponse> depositAmountTxn(BankTransactionRequestDto request) throws Exception {
		...
		transaction.setTransactionId(TransactionIdgenerator.Idgenerator());
	...
	public ResponseEntity<CommonApiResponse> withdrawAmountTxn(BankTransactionRequestDto request) throws Exception {
		...
		BankAccountTransaction transaction = new BankAccountTransaction();
		transaction.setType(TransactionType.WITH_DRAW.value());
		transaction.setBank(bank);
		transaction.setBankAccount(account);
		transaction.setAmount(request.getAmount());
	...
	public void downloadBankStatement(int accountId, String startTime, String endTime, HttpServletResponse response)
		...
		BankStatementDownloader exporter = new BankStatementDownloader(bankAccountTransactions,
				...
				DateTimeUtils.getLocalDateTimeFromEpochTime(endTime));
